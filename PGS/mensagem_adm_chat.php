        ...
        $(document).ready(function(){
            ...
            if (mensagem == "") {
                ...
                $.ajax({ //iniciando o ajax
                    method: 'POST', // método
                    url: 'enviar_chat_adm.php', //destino
                    data: {
                        'mensagem': mensagem
...
?>
    ...
    <div class="mensagem ">
        <form action="" method="POST">
            <table class = "chat">
                <tr>
                    <th class = "titulo_mensagem">
                        <?php
                            
                            $usu_select = $_GET["usu_select"];
                            echo $usu_select;
                            $_SESSION["usu_select"] = $usu_select;
                        ?>
                    </th>
                </tr>
                <div id = "chat_reload" class="chat_reload">
                    ...
                    /*echo $email_usuario; ADM COMO EMAIL_LOGADO*/ 
                    $teste = true;
                    ...
                    do {
                        ...
                        if(($registro["email_usuario_mensagem_de"] == $email_usuario)||($registro["email_usuario_mensagem_para"] == $email_usuario)) {
                            if(($registro["email_usuario_mensagem_de"] == $usu_select)||($registro["email_usuario_mensagem_para"] == $usu_select)) {
                                if($registro["email_usuario_mensagem_de"] == $email_usuario){
